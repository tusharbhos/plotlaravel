            ...
            <div>
                ...
                <form method="POST" action="{{ route('plots.import') }}" enctype="multipart/form-data" id="importForm">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-indigo-400 transition cursor-pointer mb-4"
                        ...
                        <input type="file" name="excel_file" id="excelFile" accept=".xlsx,.xls,.csv" class="hidden" onchange="handleFileSelect(this)" required />
                    </div>
                    ...
                    <div class="flex justify-end gap-3">
                        <a href="{{ route('plots.index') }}" class="px-5 py-2 text-gray-600 hover:text-gray-800 font-medium">
                            Cancel
                        </a>
